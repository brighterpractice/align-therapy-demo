...
export const services: Service[] = [
 ...
 { slug: 'anxiety-stress', title: 'Anxiety & Stress', href: '/services/anxiety-stress/', description: 'Support for worry, tension, overwhelm, physical stress responses, and patterns that make it difficult to feel settled.', homeDescription: 'Space to work with worry, tension, overwhelm, and patterns that make it hard to settle.', showOnHome: true, published: true, hasDetailPage: true },
 ...
 { slug: 'depression-emotional-disconnection', title: 'Depression & Emotional Disconnection', href: '/services/depression-emotional-disconnection/', description: 'Counseling when you may be experiencing low mood, loss of interest, emotional distance, or a sense of feeling stuck.', homeDescription: 'Support when you feel low, distant from yourself or others, or emotionally stuck.', showOnHome: true, published: true, hasDetailPage: true },
 ...
 { slug: 'relationship-concerns', title: 'Relationship Concerns', href: '/services/relationship-concerns/', description: 'Individual counseling to explore communication, boundaries, connection, conflict, and recurring relationship patterns.', homeDescription: 'Individual counseling for patterns involving communication, boundaries, connection, or conflict.', showOnHome: true, published: true, hasDetailPage: true },
